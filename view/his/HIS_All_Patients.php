...
$delete_patient_controller = $backend_routes['delete_patient_controller'];
...
<div class="table-container" style="position: relative;">
    <div class="add-new-button" style="position: absolute; top: 10px; left: 10px;" ><a href="<?php echo $his_create_patient; ?>" style="">+ Add New</a></div>
    ...
    <table>
        ...
        foreach ($all_patients as $patient) {
            echo "<tr>
                    ...
                    <td>
                        <form action='$his_single_patient' method='POST'>
                            <input type='hidden' name='view_patient_id' value='{$patient['id']}'>
                            <button type='submit' class='view-btn'>View</button>
                        </form>
                    </td>
                    <td>
                        <form action='$delete_patient_controller' method='POST'>
