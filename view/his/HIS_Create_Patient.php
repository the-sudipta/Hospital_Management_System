...
$create_patient_controller = $backend_routes['create_patient_controller'];
...
<head>
    ...
    <title>HIS - Create New Patient</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="form-container" id="formContainer">
    ...
    <form id="patient-form" action="<?php echo $create_patient_controller; ?>" method="POST">
        ...
        <button type="submit" class="submit-btn">Create Patient</button>
    </form>
</div>
