...
if (isset($_POST['view_bill_id'])) {
    $update_bill_id = $_POST['view_bill_id'];
    // Redirect to prevent resubmission
    header("Location: {$his_single_bill}?id={$update_bill_id}");
    exit();
}
...
if (isset($_GET['id'])) {
    $update_bill_id = $_GET['id'];
}

$single_bill_data = findBillingByID($update_bill_id);
$patient_details = findPatientByID($single_bill_data['patient_id']);
...
$status_lower = strtolower($single_bill_data['status']);
...
<div class="form-container" id="formContainer">
    ...
    <form id="patient-form" action="<?php echo $update_appointment_controller; ?>" method="POST">
        <input type='hidden' name='update_patient_id' value="<?php echo $single_bill_data['id']?>" disabled>
        ...
        <div class="input-group">
            <input type="text" id="amount" name="amount" value="<?php echo htmlspecialchars($single_bill_data['amount']).'/- BDT'; ?>" disabled>
            <label for="amount">Bill Amount</label>
            <span class="error-message"></span>
        </div>

        <div class="input-group">
            <input type="text" id="bill_date" name="bill_date" value="<?php echo htmlspecialchars($single_bill_data['date']); ?>" disabled>
            <label for="bill_date">Billing Date</label>
            <span class="error-message"></span>
        </div>

        <div class="input-group">
            <input type="text" id="contact" name="contact" value="<?php echo htmlspecialchars($patient_details['contact'])?>" disabled>
        ...
        <div class="input-group">
            ...
            <span class="status-badge <?php echo $status_class; ?>">
                <?php echo htmlspecialchars($single_bill_data['status']); ?>
             </span>

            <!-- Hidden Input to Send Data to Backend -->
            <input type="hidden" id="status" name="status" value="<?php echo htmlspecialchars($single_bill_data['status']); ?>">
