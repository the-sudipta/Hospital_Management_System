...
$create_schedule_controller = $backend_routes['create_schedule_controller'];
$update_schedule_controller = $backend_routes['update_schedule_controller'];
...
if (isset($_POST['view_schedule_id'])) {
    $update_schedule_id = $_POST['view_schedule_id'];
    // Redirect to prevent resubmission
    header("Location: {$ris_single_schedule}?id={$update_schedule_id}");
    exit();
}
...
if (isset($_GET['id'])) {
    $update_schedule_id = $_GET['id'];
}

$single_schedule_data = findTestScheduleByID($update_schedule_id);
$patient_details = findPatientByID($single_schedule_data['patient_id']);
...
<head>
    ...
    <title>RIS - Create Schedule</title>
...
<div class="form-container" id="formContainer" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    ...
    <form id="schedule-form" action="<?php echo $update_schedule_controller; ?>" method="POST">

        <input type='hidden' name='update_schedule_id' value="<?php echo $single_schedule_data['id']?>">
        ...
        <div class="input-group">
            <input type="text" id="exam_type" name="exam_type" value="<?php echo $single_schedule_data['exam_type']; ?>">
            <label for="exam_type">Diagnosis Type</label>
            <span class="error-message"></span>
        </div>

        <div class="input-group">
            <input type="date" id="schedule_date" name="schedule_date" value="<?php echo $single_schedule_data['date']; ?>">
            <label for="schedule_date">Diagnosis Date</label>
            <span class="error-message"></span>
        </div>

        <div class="input-group">
            <input type="text" id="patient_contact" name="patient_contact" value="<?php echo $patient_details['contact']; ?>" disabled>
