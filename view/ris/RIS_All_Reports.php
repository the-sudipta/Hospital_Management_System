...
<div class="table-container" style="position: relative;">
    <div class="add-new-button" style="position: absolute; top: 10px; left: 10px;" ><a href="<?php echo $ris_create_report; ?>" style="">+ Add New</a></div>
    ...
    <table>
        ...
        foreach ($all_reports as $report) {
            $patient_name = getPatientNameByID($report['patient_id']);
            ...
            echo "<tr>
                    ...
                    <td>
                        <form action='$ris_single_report' method='POST'>
                            <input type='hidden' name='view_report_id' value='{$report['id']}'>
                            <button type='submit' class='view-btn'>View</button>
                        </form>
                    </td>
                    <td>
                        <form action='$delete_report_controller' method='POST'>
