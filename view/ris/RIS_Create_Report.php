...
$create_report_controller = $backend_routes['create_report_controller'];
...
<div class="form-container" id="formContainer" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    ...
    <form id="report-form" action="<?php echo $create_report_controller; ?>" method="POST">
