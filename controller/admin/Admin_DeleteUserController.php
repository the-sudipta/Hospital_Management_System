...
$deactivate_user_id = $_POST['delete_user_id'];

$decision = false;

echo '<br><h1> Received Patient ID = '.$deactivate_user_id.'</h1><br>';

try {
    $decision = updateUserStatus('Deactivated', $deactivate_user_id);
    if ($decision) {
